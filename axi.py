...
logo = """
\033[1;91m     ___      ___   ___  __          
\033[1;92m    /   \     \  \ /  / |  |             
\033[1;93m   /  ^  \     \  V  /  |  | 
\033[1;94m  /  /_\  \     >   <   |  |             
\033[1;95m /  _____  \   /  .  \  |  |            
\033[1;96m/__/     \__\ /__/ \__\ |__|      
\033[1;98m Auther   :AJ AWAN
\033[1;99m TOOL    : PAID
...
class Main:
	def __init__(self):
		...
		self.cp = []
		self.loop = 0
		self.ips = requests.get('https://raw.githubusercontent.com/Tech-ZulfiQar-MaGsi/ZF/main/server.txt').text
		os.system("clear")
		time.sleep(4)
		os.system("clear")
		os.system("figlet AXI")
		print(" -------------------------------------")
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		print(" [•] GITHUB : https://github.com/ahmad77412")
		exit()
	else:
		Main()
